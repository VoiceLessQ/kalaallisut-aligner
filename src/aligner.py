...
class SentenceAligner:
    ...
    def split_sentences(self, text):
        ...
        months = {
            ...
            'januaari', 'februaari', 'martsi', 'apriili', 'maaji', 'juuni',
    ...
    def calculate_similarity(self, danish_sent, kal_sent, da_pos, kal_pos):
        ...
        word_score = 1.0 - abs(word_ratio - self.expected_word_ratio) / self.expected_word_ratio
        char_score = 1.0 - abs(char_ratio - self.expected_char_ratio) / self.expected_char_ratio
